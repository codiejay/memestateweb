...
const AboutUsModal = ({ img, alt, name, title, content }) => {
  ...
  return (
    ...
    >
      <div className="border-[12px] border-[#282B7F] min-h-[470px] h-fit max-w-[1102px] rounded-[32px] overflow-hidden w-full bg-[#FFFDF1] px-6 py-8">
