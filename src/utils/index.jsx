...
export const contentList = [
  {
    ...
    text: (
      <p className="max-w-2xl font-poppins my-5  lg:text-xl text-[14px] lg:text-left text-center">
  ...
  },
  {
    ...
    text: (
      <p className="lg:max-w-xl font-poppins my-5 lg:text-base text-[14px] lg:text-left text-center">
